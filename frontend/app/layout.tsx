            ...
            <div className="container mx-auto px-4 flex justify-between items-center">
              ...
              <nav>
                <ul className="flex space-x-6">
                  <li><a href="/" className="hover:text-[#D5A021] transition-colors">Home</a></li>
                  <li><a href="/upload" className="hover:text-[#D5A021] transition-colors">Upload</a></li>
                  <li><a href="/research" className="hover:text-[#D5A021] transition-colors">Research</a></li>
                  <li><a href="/compliance" className="hover:text-[#D5A021] transition-colors">Compliance</a></li>
                </ul>
              </nav>
            </div>
          </header>
